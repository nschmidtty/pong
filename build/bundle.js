...
var svgTag = exports.svgTag = document.getElementsByTagName('svg')[0];
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render() {
      var background = document.createElementNS(_settings2.default, 'rect');
      ...
      var middle = document.createElementNS(_settings2.default, 'line');
      ...
      middle.setAttributeNS(null, 'stroke-dasharray', 18, 8);

      _settings2.default.appendChild(background);
      _settings2.default.appendChild(middle);
    }
  }]);
...
var Game = function () {
	...
	_createClass(Game, [{
		key: 'render',
		value: function render() {
			var svg = document.createElementNS(_settings2.default, 'svg');
